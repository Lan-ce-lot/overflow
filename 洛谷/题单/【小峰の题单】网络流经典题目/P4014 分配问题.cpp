...
vector<edge> G[maxn];				
int h[maxn];						// é¡¶ç‚¹çš„åŠ¿
int dis[maxn];						// æœ€çŸ­è·ç¦»
int prevv[maxn], preve[maxn];		// æœ€çŸ­è·¯ä¸­çš„å‰é©±èŠ‚ç‚¹å’Œå¯¹åº”çš„è¾¹

vector<int> res;
// åŠ ä¸€æ¡ä»fromåˆ°toå®¹é‡ä¸ºcapè´¹ç”¨ä¸ºcostçš„è¾¹
...
ll min_cost_flow(int s, int t, ll f = INF) {// ×îĞ¡·ÑÓÃ×î´óÁ÷£¬f = INF, ×îĞ¡·ÑÓÃÁ÷£¬ÓÃf = sÁ÷³ö»òÁ÷ÈëµÄºÍ 
	ll ans = 0, flow = 0;
	fill(h, h + t + 1, 0);
